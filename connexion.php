...
<body>
  <!-- menu nav -->
  <ul id="nav">
        <li><a href="/livredor/index.php">Home</a></li>
        <li><a href="/livredor/inscription.php">S'inscrire</a></li>
        <li><a class="active" href="/livredor/connexion.php">Se Connecter</a></li>
    </ul>
<section id="main">
    <div id="form"> 
    <br>
                ...
                session_start();
                    ...
                    if(isset($username) AND isset($password) ){
                        ...
                        if($count!=0){ // nom d'utilisateur et mot de passe correctes
                            ...
                            header('Location:http://localhost/livredor/profil.php'); //redirigé vers la page profil.php
                        }
                        elseif($count==0){
